...
#include <duatic_geometry_msgs/msg/state.hpp>
#include <duatic_geometry_msgs/msg/state_stamped.hpp>
...
public:
  ...
  using msg = duatic_geometry_msgs::msg::State;
  using msg_stamped = duatic_geometry_msgs::msg::StateStamped;
