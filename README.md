...
* **`duatic_ros_helpers`**: ROS 2 runtime helpers for controller management, robot detection, joint trajectory control, visualization, and safety nodes (e-stop, joint parking).
